...
import time
global ser
ser = serial.Serial('/dev/ttyUSB0', 115200, timeout=10, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, bytesize=serial.EIGHTBITS)
...
class Main(QWidget):
    ...
    def mainDesign(self):
        ...
        self.label1.setText ("Rp" + " " + str(stok[0]))
