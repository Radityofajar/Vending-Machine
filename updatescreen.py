...
class UpdateScreen(QWidget):
    ...
    def widgets(self):
        ...
        self.titleText=QLabel("Update Screensaver")
        #################widgets of bottom layot###########
        self.uploadBtn=QPushButton("Upload")
        self.uploadBtn.clicked.connect(self.uploadImg)
        self.submitBtn=QPushButton("Submit")
        self.submitBtn.clicked.connect(self.funcAddProduct)
    ...
    def uploadImg(self):
        global defaultImg
        size=(200,200)
        self.filename,ok = QFileDialog.getOpenFileName(self,"Upload Image","","Image Files (*.jpg *.mp4)")
        if ok:
            print(self.filename)
